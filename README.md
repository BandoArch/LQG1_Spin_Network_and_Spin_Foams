A small qiskit qiskit 2.0 primitives project showcasing that space is merely an emmergence of quantum relations
...
one Planck area which locked the qubits into a non-zero entangled state.
